...
translations.en = {
  ...
  about: {
    ...
    team: {
      ...
      members: [
        { name: 'Ahmed El Aleoui Baban', role: 'Co-Founder & Developer', bio: 'Co-founder of Digital Dune. Full-stack developer building web and mobile products for the region and beyond.', initials: 'AE', color: '#c1694f', image: 'images/Ahmed_El_Aleou.png' },
...
translations.fr = {
  ...
  about: {
    ...
    team: {
      ...
      members: [
        { name: 'Ahmed El Aleoui Baban', role: 'Co-fondateur & D\u00e9veloppeur', bio: 'Co-fondateur de Digital Dune. D\u00e9veloppeur full-stack cr\u00e9ant des produits web et mobiles pour la r\u00e9gion et au-del\u00e0.', initials: 'AE', color: '#c1694f', image: 'images/Ahmed_El_Aleou.png' },
...
translations.ar = {
  ...
  footer: {
    tagline: 'ديجيتال دون — وكالة برمجيات من نواكشوط، نبني بها تطبيقات الويب والجوال ومنصات SaaS وحلول الذكاء الاصطناعي.',
    linksTitle: '\u0627\u0644\u062a\u0646\u0642\u0644',
    servicesTitle: '\u0627\u0644\u062e\u062f\u0645\u0627\u062a',
    contactTitle: '\u0627\u0644\u0627\u062a\u0635\u0627\u0644',
    langTitle: '\u0627\u0644\u0644\u063a\u0629',
    rights: '\u0662\u0660\u0662\u0666 \u00a9 \u062f\u064a\u062c\u064a\u062a\u0627\u0644 \u062f\u0648\u0646. \u062c\u0645\u064a\u0639 \u0627\u0644\u062d\u0642\u0648\u0642 \u0645\u062d\u0641\u0648\u0638\u0629.',
  ...
  home: {
    hero: {
      ...
      lead: 'وكالة برمجيات من نواكشوط — نصمم ونبني تطبيقات الويب والجوال ومنصات SaaS ووكلاء الذكاء الاصطناعي.',
    ...
    testimonials: {
      ...
      items: [
        { text: 'تعاونّا مع ديجيتال دون لإطلاق منصة التوصيل الخاصة بنا في أقل من ثلاثة أشهر. فريقهم فهم احتياجاتنا بسرعة وقدموا حلاً متكاملاً يتناسب مع سوقنا المحلي.', name: 'أحمد ولد', role: 'مؤسس، Tawary', initials: 'أو' },
        { text: 'كنا بحاجة إلى منصة SaaS متعددة اللغات تدعم العربية والفرنسية والإنجليزية. ديجيتال دون صمم وبنى المنصة من الصفر خلال المدة المحددة وبأقل تكلفة مقارنة بالعروض الأخرى.', name: 'فاطمة سك', role: 'CTO، Mauritel', initials: 'فس' },
        { text: 'المساعد الذكي الذي طورته ديجيتال دون خفض أوقات استجابة خدمة العملاء بنسبة 60% في أول شهرين فقط. أصبح فريقنا قادراً على خدمة عدد أكبر من العملاء بنفس العدد من الموظفين.', name: 'سيدي ديالو', role: 'رئيس العمليات، Saham', initials: 'سد' }
      ]
    },
    stats: {
      items: [
  ...
  services: {
    hero: {
      ...
      lead: 'من موقع تعريفي بسيط إلى منصة ذكاء اصطناعي متكاملة — نغطي كل ما تحتاجه.'
    },
    list: [
  ...
  portfolio: {
    hero: {
      ...
      lead: 'منتجاتنا تجمع بين تطبيقات حقيقية في الإنتاج ومشاريع تصورية — كلها تعكس كيف نفكر ونبني في الويب والجوال ومنصات SaaS والذكاء الاصطناعي.'
    },
    filters: { all: '\u0627\u0644\u0643\u0644', web: '\u0648\u064a\u0628', mobile: '\u062c\u0648\u0627\u0644', saas: 'SaaS', ai: '\u0630\u0643\u0627\u0621 \u0627\u0635\u0637\u0646\u0627\u0639\u064a' },
    conceptLabel: 'مشروع تصوري',
    projects: [
  ...
  about: {
    hero: {
      ...
      lead: '\u062a\u0623\u0633\u0633 \u062f\u064a\u062c\u064a\u062a\u0627\u0644 \u062f\u0648\u0646 \u0641\u064a \u0646\u0648\u0627\u0643\u0634\u0648\u0637 \u0644\u0625\u062b\u0628\u0627\u062a \u0623\u0646 \u0627\u0644\u0645\u0646\u062a\u062c\u0627\u062a \u0627\u0644\u0631\u0642\u0645\u064a\u0629 \u0627\u0644\u0639\u0627\u0644\u0645\u064a\u0629 \u064a\u0645\u0643\u0646 \u0628\u0646\u0627\u0624\u0647\u0627 \u0645\u0646 \u0623\u064a \u0645\u0643\u0627\u0646.'
    },
    story: {
      title: '\u0642\u0635\u062a\u0646\u0627',
      ...
      p2: 'انطلق ديجيتال دون ليوجّه هذه الطاقة في بناء منتجات رقمية حقيقية. نحن وكالة متكاملة — من البنية التحتية إلى تطبيقات الجوال ووكلاء الذكاء الاصطناعي، ندير كل شيء باحترافية.'
    },
    values: {
      eyebrow: '\u0645\u0627 \u0646\u0624\u0645\u0646 \u0628\u0647',
    ...
    team: {
      ...
      members: [
        { name: '\u0623\u062d\u0645\u062f \u0627\u0644\u0639\u0644\u0648\u064a \u0628\u0627\u0628\u0627\u0646', role: '\u0645\u0624\u0633\u0633 \u0648\u0645\u0637\u0648\u0631', bio: '\u0645\u0624\u0633\u0633 \u062f\u064a\u062c\u064a\u062a\u0627\u0644 \u062f\u0648\u0646. \u0645\u0637\u0648\u0631 full-stack \u064a\u0628\u0646\u064a \u0645\u0646\u062a\u062c\u0627\u062a \u0627\u0644\u0648\u064a\u0628 \u0648\u0627\u0644\u062c\u0648\u0627\u0644.', initials: '\u0623\u0628', color: '#c1694f', image: 'images/Ahmed_El_Aleou.png' },
        { name: '\u0645\u062d\u0645\u062f \u0639\u0628\u062f \u0627\u0644\u0644\u0647 \u0628\u0627\u0628\u0627\u0646\u0627', role: '\u0645\u0624\u0633\u0633 \u0648\u0645\u0637\u0648\u0631', bio: '\u0645\u0624\u0633\u0633 \u062f\u064a\u062c\u064a\u062a\u0627\u0644 \u062f\u0648\u0646 \u064a\u0647\u062a\u0645 \u0628\u0628\u0646\u0627\u0621 \u0628\u0631\u0645\u062c\u064a\u0627\u062a \u062a\u062d\u0644 \u0645\u0634\u0627\u0643\u0644 \u062d\u0642\u064a\u0642\u064a\u0629.', initials: '\u0645\u0628', color: '#d4a853', image: 'images/Mohamed_Abdellahi_Babana.jpeg' },
